...
const WidgetDomPage = React.lazy(() => import('./pages/WidgetDomPage'));
const FundLandingPage = React.lazy(() => import('./pages/FundLandingPage'));
    ...
    <ErrorBoundary>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path='/widget-dom/:fundId' element={<WidgetDomPage />} />
          <Route path='/f/:fundId' element={<FundLandingPage />} />
